...
const PROJECTS: ProjectWithImages[] = [
  ...
  },
  {
    ...
    type: "Campaign",
    images: [
      "/images/bob-lebanese-logic.png",
      "/images/bob-lira.png",
      "/images/bob-colors.png",
      "/images/bob-opportunities.png",
      "/images/bob-broke-transfers.png",
      "/images/bob-traffic.png",
      "/images/bob-flight.png",
      "/images/bob-retail.png",
    ],
    overview:
